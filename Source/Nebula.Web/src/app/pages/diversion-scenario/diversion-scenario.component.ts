...
export class DiversionScenarioComponent implements OnInit {
  ...
  public timeSeriesForm = new FormGroup({
    ...
    rainfallEventShutdown: new FormControl(true, [Validators.required]),
    rainfallEventDepthThreshold: new FormControl(0.1, [Validators.required]),
    eventSeperationTime: new FormControl(6, [Validators.required]),
    afterRainDelay: new FormControl(72, [Validators.required]),
  ...
  public getTimeSeriesData() {
    ...
    let swnTimeSeriesRequestDto =
    {
      ...
      rainfall_event_shutdown: this.timeSeriesForm.get('rainfallEventShutdown').value,
      rainfall_event_depth_threshold: this.timeSeriesForm.get('rainfallEventDepthThreshold').value,
      event_seperation_hrs: this.timeSeriesForm.get('eventSeperationTime').value,
      after_rain_delay_hrs: this.timeSeriesForm.get('afterRainDelay').value,
