...
namespace Nebula.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given penebulads overlap each other.
        /// </summary>
        /// <param name="startDate1">Base penebulad start</param>
        /// <param name="endDate1">Base penebulad end</param>
        /// <param name="startDate2">Test penebulad start</param>
        /// <param name="endDate2">Test penebulad end</param>
        /// <returns>
        /// 	<c>true</c> if the penebulads overlap; otherwise, <c>false</c>.
        /// </returns>
