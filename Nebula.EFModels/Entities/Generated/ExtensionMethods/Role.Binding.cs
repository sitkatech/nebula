...
namespace Nebula.EFModels.Entities
{
    ...
    {
        public static readonly RoleAdmin Admin = Nebula.EFModels.Entities.RoleAdmin.Instance;
        public static readonly RoleDataExplorer DataExplorer = Nebula.EFModels.Entities.RoleDataExplorer.Instance;
        public static readonly RoleUnassigned Unassigned = Nebula.EFModels.Entities.RoleUnassigned.Instance;
        public static readonly RoleDisabled Disabled = Nebula.EFModels.Entities.RoleDisabled.Instance;
        ...
        static Role()
        {
            All = new List<Role> { Admin, DataExplorer, Unassigned, Disabled };
            AllAsDto = new List<RoleDto> { Admin.AsDto(), DataExplorer.AsDto(), Unassigned.AsDto(), Disabled.AsDto() };
    ...
    public partial class RoleDataExplorer : Role
    {
        private RoleDataExplorer(int roleID, string roleName, string roleDisplayName, string roleDescription, int sortOrder) : base(roleID, roleName, roleDisplayName, roleDescription, sortOrder) {}
        public static readonly RoleDataExplorer Instance = new RoleDataExplorer(2, @"Data Explorer", @"Data Explorer", @"", 20);
    }
