...
namespace Qanat.API.GeoSpatial
{
    public static class GeoJsonHelpers
    {
        public static FeatureCollection GetFeatureCollectionFromGeoJsonFile(string pathToGeoJsonFile,
            int coordinatePrecision, int srid)
        {
            ...
            int coordinatePrecision, int srid)
        {
            ...
            using (var jsonReader = new JsonTextReader(streamReader))
            {
                featureCollection = ExtractFeatureCollectionFromJson(coordinatePrecision, jsonReader, srid);
            }

            return featureCollection;
        }

        public static FeatureCollection ExtractFeatureCollectionFromJson(int coordinatePrecision, JsonTextReader jsonReader, int srid)
        {
            var scale = Math.Pow(10, coordinatePrecision);
            var geometryFactory = new GeometryFactory(new PrecisionModel(scale),
                srid);
        ...
        public static List<IFeature> GetFeatureCollectionFromGeoJsonByteArray(byte[] fileContentsByteArray,
            int coordinatePrecision, IPreparedGeometry boundingBox, int srid)
        {
            var featureCollection = GetFeatureCollectionFromGeoJsonByteArray(fileContentsByteArray, coordinatePrecision, srid);
        ...
        public static Geometry GetExtentForFeatureCollection(FeatureCollection featureCollection, int srid)
        {
