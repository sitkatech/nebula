...
namespace Nebula.API.Services.Authorization
{
    public abstract class BaseAuthorizationAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var dbContextService = context.HttpContext.RequestServices.GetService(typeof(NebulaDbContext));
            if (dbContextService == null || !(dbContextService is NebulaDbContext dbContext))
            {
                //MK 1/16/2018 - If we don't have a repository we are in a terrible state.
                throw new ApplicationException(
                    "Could not find injected NebulaDbRepository. WithRightsAttribute.cs needs your help!");
            }
